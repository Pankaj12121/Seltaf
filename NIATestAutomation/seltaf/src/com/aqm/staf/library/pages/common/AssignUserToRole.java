...
public class AssignUserToRole extends BasePage{
	...
	private PageElement roleCodeOnWindowFindButton;
	...
	public AssignUserToRole(WebDriver driver, String pageName) {
		...
		roleCodeOnWindowFindButton=new PageElement(By.xpath("//td//b[contains(text(),'Code')]/following::input/following::a[@name='firstFocus']"), "Role Window code Find Button", false, WaitType.WAITFORELEMENTTOBECLICKABLE, 10);
	...
	private void fillRoleCode(SecurityPartyEntity securityPartyEntity) throws InterruptedException {
		...
		click(roleCodeOnWindowFindButton);
