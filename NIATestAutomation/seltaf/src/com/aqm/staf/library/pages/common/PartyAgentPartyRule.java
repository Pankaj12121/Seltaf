...
public class PartyAgentPartyRule extends BasePage{
	...
	public PartyAgentPartyRule(WebDriver driver, String pageName) {
		...
		originalIRDAILicenseIDCardSubmittedDropDown=new PageElement(By.xpath("//td//b[contains(text(),'Original IRDAI License & ID Card Submitted')]/following::select"),"Original IRDAI License & ID Card Submitted", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		 ...
		 panNoTextField=new PageElement(By.xpath("//td//b[contains(text(),'Pan Number')]/following::input"),"Pan Number", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		 brnachNameTextField=new PageElement(By.xpath("//td//b[contains(text(),'Branch Name')]/following::input"),"Branch Name", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
	     brnachTypeDropDown=new PageElement(By.xpath("//td//b[contains(text(),'Branch Type')]/following::select"),"Branch Type", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
