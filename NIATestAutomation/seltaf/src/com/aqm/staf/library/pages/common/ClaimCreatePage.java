...
public class ClaimCreatePage extends BasePage {
	...
	public ClaimCreatePage(WebDriver driver, String pageName) {
		...
		claimNumberLabel = new PageElement(By.xpath(genericLocatorforLabel("S0050","Number")), "Claim Number Label", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10); 
				...
				if(claimEntityListData.getParentKey().equalsIgnoreCase(financialSummaryTableListData.getChildKey())){
					if(financialSummaryTableListData.getAction().equalsIgnoreCase("verify")){
						...
						if (financialSummaryTableListData.getBooleanValueForField("ConfigSlNo")) {
							srNumber = new PageElement(By.xpath("//form[1]/div[2]/table/tbody/tr/td/table/tbody/tr["+datarow+"]/td[1]"), "Sl No", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
						...
						if (financialSummaryTableListData.getBooleanValueForField("ConfigReserveType")) {
							reserveType = new PageElement(By.xpath("//form[1]/div[2]/table/tbody/tr/td/table/tbody/tr["+datarow+"]/td[2]"), "Reserve Type", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
						...
						if (financialSummaryTableListData.getBooleanValueForField("ConfigReserveAmount")) {
							amount = new PageElement(By.xpath("//form[1]/div[2]/table/tbody/tr/td/table/tbody/tr["+datarow+"]/td[3]"), "Reserve Amount", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
						...
						if (financialSummaryTableListData.getBooleanValueForField("ConfigPaidAmount")) {
							paidAmount = new PageElement(By.xpath("//form[1]/div[2]/table/tbody/tr/td/table/tbody/tr["+datarow+"]/td[4]"), "Paid Amount", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
						...
						if (financialSummaryTableListData.getBooleanValueForField("ConfigPendingAmount")) {
							pendingAmount = new PageElement(By.xpath("//form[1]/div[2]/table/tbody/tr/td/table/tbody/tr["+datarow+"]/td[5]"), "Pending Amount", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
