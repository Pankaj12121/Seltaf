...
public class PolicyAttributeHealth extends BasePage {
	...
	public PolicyAttributeHealth(WebDriver driver, String pageName) {
		...
		dateOfFirstPolicyTextField= new PageElement(By.xpath(locatorforQuestionAnswerPanel("Date of First Policy", "input")), "Date Of First policy", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		...
		assigneenameTextField= new PageElement(By.xpath(locatorforQuestionAnswerPanel("Assignee name", "textarea")), "Assignee name Text Field", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		relationshipWithAssigneeDropDown= new PageElement(By.xpath(locatorforQuestionAnswerPanel("Relationship with the Assignee", "select")), "Premium in Forex Drop Down ", false,WaitType.WAITFORELEMENTTOBEEENABLED, 10);
	...
	public void fillpolicyAttributeHealthDetailsOnNextPage(PolicyAttributeHealthEntity policyAttributeHealthEntity, CustomAssert assertReference){
		if(policyAttributeHealthEntity.getAction().equalsIgnoreCase("add") || policyAttributeHealthEntity.getAction().equalsIgnoreCase("edit")){
			...
			if ((policyAttributeHealthEntity.getStringValueForField("Product").equalsIgnoreCase("SP") || policyAttributeHealthEntity.getStringValueForField("Product").equalsIgnoreCase("GJ")||policyAttributeHealthEntity.getStringValueForField("Product").equalsIgnoreCase("CG")||policyAttributeHealthEntity.getStringValueForField("Product").equalsIgnoreCase("CX")||policyAttributeHealthEntity.getStringValueForField("Product").equalsIgnoreCase("SC"))){
				{
					if (policyAttributeHealthEntity.getBooleanValueForField("ConfigCompanyNameOfThePreviousInsuranceCompany")) {
						clearAndSendKeys(companyNameOfThePreviousInsuranceCompanyTextField, policyAttributeHealthEntity.getStringValueForField("CompanyNameOfThePreviousInsuranceCompany"));
					}
	...
	public void clickNextButtonPolicyAttributeHealthDetails(PolicyAttributeHealthEntity policyAttributeHealthEntity) throws InterruptedException{
		if (policyAttributeHealthEntity.getBooleanValueForField("ConfigForwordButton")){	
			...
			/*else if(policyAttributeHealthEntity.getBooleanValueForField("ConfigClaimYears")){
				...
				//TODO WorkAround
				if(!policyAttributeHealthEntity.getAction().equalsIgnoreCase("verify")){
					if(!(policyAttributeHealthEntity.getStringValueForField("Product").equalsIgnoreCase("BH")||(policyAttributeHealthEntity.getStringValueForField("LOB").equalsIgnoreCase("Misc Liability")||(policyAttributeHealthEntity.getStringValueForField("Product").equalsIgnoreCase("SC"))||(policyAttributeHealthEntity.getStringValueForField("Product").equalsIgnoreCase("RS"))))){
	...
	public void workAround(PolicyAttributeHealthEntity policyAttributeHealthEntity){
		...
		workAroundForPolicySearch(policyAttributeHealthEntity);
		click(proceedButton);
		switchToFrame("display");
		click(forwordButton);
	...
	public void workAroundForPolicySearch(PolicyAttributeHealthEntity policyAttributeHealthEntity){
