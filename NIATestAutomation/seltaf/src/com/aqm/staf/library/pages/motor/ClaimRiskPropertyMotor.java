...
public class ClaimRiskPropertyMotor extends BasePage{
	...
	public ClaimRiskPropertyMotor(WebDriver driver, String pageName,int rowCounts) {
		...
		natureOfPermitTextField= new PageElement(By.xpath("//td//div[contains(text(),'Nature of Permit ')]/following::input"), "Nature of Permit  TextField", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		...
		numberOfPassengersCarriedTextField= new PageElement(By.xpath("//td//div[contains(text(),'Number of passengers carried')]/following::input"), "Number of passengers carried TextField", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		numberOfPassengerAsPerPermitTextField= new PageElement(By.xpath("//td//div[contains(text(),'Number of passengers carried')]/following::input"), "Number of passengers carried TextField", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
