...
public class PolicyInsuredIntrestVehicleValueDetailsMotor extends BasePage {
	...
	public PolicyInsuredIntrestVehicleValueDetailsMotor(WebDriver driver, String pageName) {
		...
		nCBApplicablePercentageDropDown=new PageElement(By.xpath("//td/div[contains(text(),'NCB Applicable Percentage')]/following::select"),"NCB Applicable Percentage", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
	...
	public void fillPolicyInsuredIntrestVehicleValueDetailsMotor(PolInsIntVehVaDetMotorEntity polInsIntVehVaDetMotorEntity, CustomAssert assertReference) throws InterruptedException{
		if(polInsIntVehVaDetMotorEntity.getAction().equalsIgnoreCase("add") || polInsIntVehVaDetMotorEntity.getAction().equalsIgnoreCase("edit")){
			...
			if (polInsIntVehVaDetMotorEntity.getBooleanValueForField("ConfigNameAndAddressOfRegistrationAuthority")) {
				clearAndSendKeys(nameAndAddressOfRegistrationAuthorityTextarea, polInsIntVehVaDetMotorEntity.getStringValueForField("NameAndAddressOfRegistrationAuthority"));
			}
			...
			if (polInsIntVehVaDetMotorEntity.getBooleanValueForField("ConfigFibreGlassFuelTanks")) {
				selectValueFromList(fibreGlassFuelTanksDropDown,polInsIntVehVaDetMotorEntity.getStringValueForField("FibreGlassFuelTanksn"));
			}
			...
			//CV-D
			if (polInsIntVehVaDetMotorEntity.getBooleanValueForField("ConfigNameAndAddressOfRegistrationAuthority")) {
				assertReference.assertEquals(polInsIntVehVaDetMotorEntity.getStringValueForField("NameAndAddressOfRegistrationAuthority"), fetchValueFromTextFields(nameAndAddressOfRegistrationAuthorityTextarea), AssertionType.WARNING);
			}
			if (polInsIntVehVaDetMotorEntity.getBooleanValueForField("ConfigExtraElectricalElectronicFittings")) {
	...
	public void clickOnForwardButton(PolInsIntVehVaDetMotorEntity polInsIntVehVaDetMotorEntity){
