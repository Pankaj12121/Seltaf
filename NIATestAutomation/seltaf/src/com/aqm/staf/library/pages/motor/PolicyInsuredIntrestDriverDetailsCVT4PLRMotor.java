...
public class PolicyInsuredIntrestDriverDetailsCVT4PLRMotor extends BasePage {
	...
	public PolicyInsuredIntrestDriverDetailsCVT4PLRMotor(WebDriver driver, String pageName) {
		...
		superficialAreaInSqMetersTextField= new PageElement(By.xpath("//td//div[contains(text(),'Superficial Area (in sq. meters)')]/following::input"), "Superficial Area (in sq. meters) TextField", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		//Mayur_Product name= CV-E
		...
		insuredsDeclaredValueIDVTextField=new PageElement(By.xpath("//td//div[contains(text(),'Insureds declared Value (IDV)')]/following::input"), "Insureds declared Value (IDV)", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		...
		nameOfPreviousInsurerTextField=new PageElement(By.xpath("//td/div[contains(text(),'Name of Previous Insurer')]/following::input"),"Name of Previous Insurer TextField", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		...
		doYouHaveAnyotherDriverDropDown=new PageElement(By.xpath("//td/div[contains(text(),'Do you Have Any other Driver')]/following::select"),"Do you Have Any other Driver DropDown", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		vehiclePermitDetailsDropDown=new PageElement(By.xpath("//td/div[contains(text(),'Vehicle Permit Details')]/following::select"),"Vehicle Permit Details DropDown", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
	...
	public void fillPolicyInsuredIntrestDriverDetailsCVT4PLRMotor(DriverDetCVT4PLRMotorEntity driverDetCVT4PLRMotorEntity, CustomAssert assertReference) throws InterruptedException{
		if(driverDetCVT4PLRMotorEntity.getAction().equalsIgnoreCase("add") || driverDetCVT4PLRMotorEntity.getAction().equalsIgnoreCase("edit")){
			...
			if (driverDetCVT4PLRMotorEntity.getBooleanValueForField("ConfigWhetherEligibleForSpecialDiscount")) {
				clearAndSendKeys(whetherEligibleForSpecialDiscountTextField, driverDetCVT4PLRMotorEntity.getStringValueForField("WhetherEligibleForSpecialDiscount"));
			}
			...
			if (driverDetCVT4PLRMotorEntity.getBooleanValueForField("ConfigSeatingCapacityIncluding")) {
				selectValueFromList(seatingCapacityIncludingDriverTextField, driverDetCVT4PLRMotorEntity.getStringValueForField("SeatingCapacityIncluding"));
			}
			if (driverDetCVT4PLRMotorEntity.getBooleanValueForField("ConfigGrossVehicleWeightGVW")) {
				selectValueFromList(grossVehicleWeightGVWTextField, driverDetCVT4PLRMotorEntity.getStringValueForField("GrossVehicleWeightGVW"));
			}
			...
			if (driverDetCVT4PLRMotorEntity.getBooleanValueForField("ConfigNameOfPreviousInsurer")) {
				clearAndSendKeys(nameOfPreviousInsurerTextField, driverDetCVT4PLRMotorEntity.getStringValueForField("NameOfPreviousInsurer"));
			}
			...
			//Mayur_Product name= CV-G
			if (driverDetCVT4PLRMotorEntity.getBooleanValueForField("ConfigWhetherEligibleForSpecialDiscount")) {
				assertReference.assertEquals(driverDetCVT4PLRMotorEntity.getStringValueForField("WhetherEligibleForSpecialDiscount"), fetchValueFromTextFields(whetherEligibleForSpecialDiscountTextField), AssertionType.WARNING);
			}
			if (driverDetCVT4PLRMotorEntity.getBooleanValueForField("ConfigSuperficialAreaInSqMetersT")) {
			...
			if (driverDetCVT4PLRMotorEntity.getBooleanValueForField("ConfigAgeOfNominee")) {
				assertReference.assertEquals(driverDetCVT4PLRMotorEntity.getStringValueForField("AgeOfNominee"), fetchValueFromTextFields(ageOfNomineeTextField), AssertionType.WARNING);
			}
			if (driverDetCVT4PLRMotorEntity.getBooleanValueForField("ConfigRelationshipWithTheInsured")) {
			...
			//**************CV-A(CHINTAN) INSURED INTREST 4th PAGE**********
			if (driverDetCVT4PLRMotorEntity.getBooleanValueForField("ConfigSeatingCapacityIncluding")) {
				assertReference.assertEquals(driverDetCVT4PLRMotorEntity.getStringValueForField("SeatingCapacityIncluding"), fetchValueFromList(seatingCapacityIncludingDriverTextField), AssertionType.WARNING);
			}
			if (driverDetCVT4PLRMotorEntity.getBooleanValueForField("ConfigGrossVehicleWeightGVW")) {
				assertReference.assertEquals(driverDetCVT4PLRMotorEntity.getStringValueForField("GrossVehicleWeightGVW"), fetchValueFromList(grossVehicleWeightGVWTextField), AssertionType.WARNING);
			}
			if (driverDetCVT4PLRMotorEntity.getBooleanValueForField("ConfigInsuredsDeclaredValueIDV")) {
			...
			if (driverDetCVT4PLRMotorEntity.getBooleanValueForField("ConfigNameOfPreviousInsurer")) {
				assertReference.assertEquals(driverDetCVT4PLRMotorEntity.getStringValueForField("NameOfPreviousInsurer"), fetchValueFromTextFields(nameOfPreviousInsurerTextField), AssertionType.WARNING);
			}
			if (driverDetCVT4PLRMotorEntity.getBooleanValueForField("ConfigPreviousPolicyNo")) {
	...
	public void clickOnForwardButton(DriverDetCVT4PLRMotorEntity driverDetCVT4PLRMotorEntity){
