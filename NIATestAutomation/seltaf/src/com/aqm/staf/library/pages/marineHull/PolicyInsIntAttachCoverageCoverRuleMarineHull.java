...
public class PolicyInsIntAttachCoverageCoverRuleMarineHull extends BasePage {
	...
	public PolicyInsIntAttachCoverageCoverRuleMarineHull(WebDriver driver, String pageName) {
		...
		sumInsuredForSectionPhysicalDamageTextField=new PageElement(By.xpath("//td/div[contains(text(),'Sum Insured for Section (Physical Damage)')]/following::input"),"Sum Insured for Section (Physical Damage)", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		deductibleForSectionPhysicalDamageTextField=new PageElement(By.xpath("//td/div[contains(text(),'Deductible for Section (Physical Damage)')]/following::input"),"Deductible for Section (Physical Damage)", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		rateBasedOrAmountBasedForSectionICoverDropDown=new PageElement(By.xpath("//td/div[contains(text(),'Rate based or Amount based for Section I Cover')]/following::select"),"Rate based or Amount based for Section I Cover", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		premiumForSectionPhysicalDamageTextField=new PageElement(By.xpath("//td/div[contains(text(),'Premium for Section (Physical Damage)')]/following::input"),"Premium for Section (Physical Damage)", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		...
		//2
		isSectionIIcoverrequiredDropDown=new PageElement(By.xpath("//td/div[contains(text(),'Is Section II cover required?')]/following::select"), "Is Section II cover required?", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		coverDescriptionforSectionIIofOffshoreEnergyDropDown=new PageElement(By.xpath("//td/div[contains(text(),'Cover Description for Section II of Offshore Energy')]/following::select"), "Cover Description for Section II of Offshore Energy", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		...
		//3
		isSectionIIICoverrequiredDropDown=new PageElement(By.xpath("//td/div[contains(text(),'Is Section III cover required?')]/following::select"), "Is Section III cover required?", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		coverDescriptionForSectionIIIOfPortPackageDropDown=new PageElement(By.xpath("//td/div[contains(text(),'Cover Description for Section III of Port Package')]/following::select"), "coverDescriptionForSectionIIIOfPortPackage", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		...
		saveButtonForRule3=new PageElement(By.name("btnSave"),"Add Button", false, WaitType.WAITFORELEMENTTOBECLICKABLE, 10);
		closeButton=new PageElement(By.name("btnClose"),"Add Button", false, WaitType.WAITFORELEMENTTOBECLICKABLE, 10);

		//2nd page
		isSectionIVcoverrequiredDropDown=new PageElement(By.xpath("//td/div[contains(text(),'Is Section IV cover required?')]/following::select"), "Is Section IV cover required?", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		...
		//2nd page (b)
		isSectionVcoverrequiredDropDown=new PageElement(By.xpath("//td/div[contains(text(),'Is Section V cover required?')]/following::select"), "Is Section V cover required?", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		...
		isSectionVIIIcoverrequiredDropDown=new PageElement(By.xpath("//td/div[contains(text(),'Is Section VIII cover required?')]/following::select"), "Is Section VIII cover required?", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		...
		coverRule3forPortPKGTitle=new PageElement(By.xpath("//div//b[contains(text(),'Cover Rule 3 for Port PKG')]"),"Cover Rule 3 for Port PKG",false,WaitType.WAITFORELEMENTTOBEDISPLAYED,10);
		//wr
	...
	//hm
		standardCoverTypeDropDown=new PageElement(By.xpath(locatorforQuestionAnswerPanel("Standard Cover Type", "select")), "Standard Cover Type", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		isPremReducCoverRequiredDropDown=new PageElement(By.xpath(locatorforQuestionAnswerPanel("Is Premium Reducing Cover required?", "select")), "Is Premium Reducing Cover", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
	}
	...
	//NEW 3rd PAGE
		...
		if (polAttCoverRuleMHEntity.getBooleanValueForField("ConfigIsSectionVIcoverrequired")) {
			assertReference.assertEquals(polAttCoverRuleMHEntity.getStringValueForField("ConfigIsSectionVIcoverrequired"), fetchValueFromList(isSectionVIcoverrequiredDropDown), AssertionType.WARNING);
		}
		if (polAttCoverRuleMHEntity.getBooleanValueForField("ConfigCoverDescriptionforSectionVIofPortPackage")) {
...
//2(b)
		...
		//2(c)
		if (polAttCoverRuleMHEntity.getBooleanValueForField("ConfigIsSectionVIIIcoverrequired")) {
			assertReference.assertEquals(polAttCoverRuleMHEntity.getStringValueForField("ConfigIsSectionVIIIcoverrequired"), fetchValueFromList(isSectionVIIIcoverrequiredDropDown), AssertionType.WARNING);
		}
		if (polAttCoverRuleMHEntity.getBooleanValueForField("ConfigCoverDescriptionForSectionVIIIofPortPackage")) {
			assertReference.assertEquals(polAttCoverRuleMHEntity.getStringValueForField("ConfigCoverDescriptionForSectionVIIIofPortPackage"), fetchValueFromList(coverDescriptionForSectionVIIIofPortPackageDropDown), AssertionType.WARNING);
		}
		if (polAttCoverRuleMHEntity.getBooleanValueForField("ConfigOtherCover3Details")) {
