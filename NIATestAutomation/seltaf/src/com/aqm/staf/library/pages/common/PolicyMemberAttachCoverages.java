...
public class PolicyMemberAttachCoverages extends BasePage {
	...
	public void fillMemberAttachCovDetails(PolicyMemAttachCovEntity policyMemAttachCovEntity, CustomAssert assertReference){
	...
	public void createNewCoverage(PolicyMemAttachCovEntity policyMemAttachCovEntity){
		if(policyMemAttachCovEntity.getAction().equalsIgnoreCase("add")){
	...
	public void fillAndSubmitAttachCoverageDetails(PolicyMemAttachCovEntity policyMemAttachCovEntity , CustomAssert assertReference) {
