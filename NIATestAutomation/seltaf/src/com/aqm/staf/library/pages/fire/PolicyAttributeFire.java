...
public class PolicyAttributeFire extends BasePage {
	...
	public PolicyAttributeFire(WebDriver driver, String pageName){
		...
		//DIGVIJAY PROD-AR 
		isTheRiskNewDropDown=new PageElement(By.xpath("//td//div[contains(text(),'Is the risk new')]/following::select"), "Is the risk new", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		isItAFreshBusinessOrRenewalDropDown=new PageElement(By.xpath("//td//div[contains(text(),'Is it a fresh business or renewal')]/following::select"), "Is it a fresh business or renewal", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		sinceWhenTheRiskIsInsuredUnderIARTextField=new PageElement(By.xpath("//td//div[contains(text(),'Since when the risk is insured under IAR')]/following::input"), "Since when the risk is insured under IAR", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		detailsOfPreviousInsurancesTextArea=new PageElement(By.xpath("//td//div[contains(text(),'Details of previous insurances')]/following::textarea"), "Details of previous insurances", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		hasThePropBePrevInsAgainstFireAndAlliedPerilsOfSFSPPolicDropDown=new PageElement(By.xpath("//td//div[contains(text(),'Has the property been previously insured against fire and allied perils of SFSP ')]/following::select"), "Has the property been previously insured against fire and allied perils ", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		hasThePropeBePrevInsAgainstMBBEEEIAndBurglaryPolicyDropDown=new PageElement(By.xpath("//td//div[contains(text(),'Has the property been previously insured against MB, BE, EEI and Burglary ')]/following::select"), "Has the property been previously insured against MB, BE, EEI and Burglary", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		...
		whetherTheInsuredSuffLossesDueToFireAndAlliedPerilsOfSFSPPolicyAtTheInsPremropDown=new PageElement(By.xpath("//td//div[contains(text(),'Whether the insured suffered loss/losses due to fire and allied perils of SFSP policy at the insured premises')]/following::select"), "'Whether the insured suffered loss/losses due to fire and allied perils of SFSP policy", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		...
		whetherTheInsSuffLossDueToMBBEEEIBurglaryPolicyAtTheInsuredPremDropDown=new PageElement(By.xpath("//td//div[contains(text(),'Whether the insured suffered loss/losses due to MB, BE, EEI,Burglary policy at the insured premises')]/following::select"), "Whether the insured suffered loss/losses due to MB, BE, EEI,Burglary policy", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		...
		whetherTheInsuredSufferedLosslossesDueToBusiInterruptMBForTheInsPremDropDown=new PageElement(By.xpath("//td//div[contains(text(),'Whether the insured suffered loss/losses due to Business Interruption (MB) for the insured premises')]/following::select"), "Whether the insured suffered loss/losses due to Business Interruption (MB) for the insured premises", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		...
		hasAnyInsurerAtAnyTimeDeclToAcceptAnyInsurPropoFromTheInsuDropDown=new PageElement(By.xpath("//td//div[contains(text(),'Has any insurer at any time declined to accept any insurance proposal from the insured')]/following::select"), "Has any insurer at any time declined to accept any insurance proposal ", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		hasAnyInsurerAtAnyTimeRefToRenewTheInsuranceCoverForTheInsPremDropDown=new PageElement(By.xpath("//td//div[contains(text(),'Has any insurer at any time refused to renew the insurance cover for the insured premises')]/following::select"), "Has any insurer at any time refused to renew the insurance cover for the insured premises", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		hasAnyInsIncrThePremOrImpSpecialAtTheTimeOfRenOrDurTheCurrOfThePoliForTheInsurLocDropDown=new PageElement(By.xpath("//td//div[contains(text(),'Has any insurer increased the premium or imposed special conditions at the time of renewal or during the currency ')]/following::select"), "Has any insurer increased the premium or imposed special conditions at the time of renewal or during the currency", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		coInsuranceApplicableDropDown=new PageElement(By.xpath("//td//div[contains(text(),'Co-Insurance Applicable')]/following::select"), "Co-Insurance Applicable", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		//digvijay prod-df
