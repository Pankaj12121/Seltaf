...
public class AccountingScrollEntryScreenPage extends BasePage {
	...
	public AccountingScrollEntryScreenPage(WebDriver driver, String pageName) {
		...
		agentCodeTextField=new PageElement(By.xpath("//td//b[contains(text(),'Agent Code')]/following::input[2]"), "Agent Code TextField", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
	...
	public void selectagentCode(AccoScrollEntryEntity accoScrollEntryEntity) throws InterruptedException{
		agentCodeToBeSelectedLink=new PageElement(By.xpath("//a[contains(text(),'"+accoScrollEntryEntity.getStringValueForField("agentCode")+"')]"),"Agent Code To Be Selected", false, WaitType.WAITFORELEMENTTOBECLICKABLE, 10);
