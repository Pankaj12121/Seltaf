...
public class PolicyInsuredIntrestRiskDetailsMiscNL extends BasePage {
	...
	public PolicyInsuredIntrestRiskDetailsMiscNL(WebDriver driver, String pageName,int rowcount) {
		...
		giveReasonforOtherLoadingTextField=new PageElement(By.xpath("//td/div[contains(text(),'Give Reason for Other Loading')]/following::TextArea"), "Give Reason for Other Loading", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
	...
	public void fillPolicyInsuredIntrestRiskDetailsMiscNLDetails(PolInsIntRiskDetMNLEntity polInsIntRiskDetMNLEntity, CustomAssert assertReference) throws InterruptedException{
		...
		if(polInsIntRiskDetMNLEntity.getAction().equalsIgnoreCase("add") || polInsIntRiskDetMNLEntity.getAction().equalsIgnoreCase("edit")){
			...
			if (polInsIntRiskDetMNLEntity.getBooleanValueForField("ConfigRelationshipOfSponsor")) {
				assertReference.assertEquals(polInsIntRiskDetMNLEntity.getStringValueForField("RelationshipOfSponsor"), fetchValueFromTextFields(relationshipOfSponsorTextField), AssertionType.WARNING);
			}
			if (polInsIntRiskDetMNLEntity.getBooleanValueForField("ConfigCountryOfVisit")) {
			...
			if (polInsIntRiskDetMNLEntity.getBooleanValueForField("ConfigNameOfWorkplace")) {
				assertReference.assertEquals(polInsIntRiskDetMNLEntity.getStringValueForField("NameOfWorkplace"), fetchValueFromTextFields(nameOfWorkplaceTextField), AssertionType.WARNING);
			}
			if (polInsIntRiskDetMNLEntity.getBooleanValueForField("ConfigAddressOfTheWorkplace")) {
	...
	public void fillandSubmitSpecialConditionForMiscNL(PolInsIntRiskDetMNLEntity polInsIntRiskDetMNLEntity, CustomAssert assertReference) throws InterruptedException {
