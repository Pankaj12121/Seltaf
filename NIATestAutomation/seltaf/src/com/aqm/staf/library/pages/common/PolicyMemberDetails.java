...
public class PolicyMemberDetails extends BasePage {
	...
	public PolicyMemberDetails(WebDriver driver, String pageName) {
		...
		insuredInterestCodeNameTextField=new PageElement(By.name("pRiskName"), "insured Interest Code Name TextField", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
