...
public class AviationRiskDetailIIT2PLR extends BasePage {
	...
	public AviationRiskDetailIIT2PLR(WebDriver driver, String pageName) {
		...
		premiumTextField= new PageElement(By.xpath("//tr[4]//td[1]//div[contains(text(),'Premium')]/following::input"), "Premium Text Field", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		...
		premiumTextFieldForSR= new PageElement(By.xpath("//td//div[@id='Premium']/following::input"), "Premium Text Field", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
