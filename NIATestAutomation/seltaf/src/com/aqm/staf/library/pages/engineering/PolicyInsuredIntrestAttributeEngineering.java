...
public class PolicyInsuredIntrestAttributeEngineering extends BasePage {
	...
	public PolicyInsuredIntrestAttributeEngineering(WebDriver driver, String pageName) {
		...
		nameOfTheMachineDropdown=new PageElement(By.xpath("//td/div[contains(text(),'Name of the Machine')]/following::select"),"Name of the Machine Dropdown", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
