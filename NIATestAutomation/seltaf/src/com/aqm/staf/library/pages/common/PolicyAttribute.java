...
public class PolicyAttribute extends BasePage {
	...
	public void fillandSubmitPolicyAttributeProccedDetails(PolicyAttributeEntity policyAttributeEntity, CustomAssert assertReference) {
		if(isConfigTrue(policyAttributeEntity.getConfigExecute())){
			...
			if(policyAttributeEntity.getStringValueForField("Product").equalsIgnoreCase("PY")||policyAttributeEntity.getStringValueForField("Product").equalsIgnoreCase("MI")||policyAttributeEntity.getStringValueForField("Product").equalsIgnoreCase("JI")|| policyAttributeEntity.getStringValueForField("Product").equalsIgnoreCase("RM"))
			{
