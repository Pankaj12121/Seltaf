...
public class PolicyAttributeAviation extends BasePage{
	...
	public PolicyAttributeAviation(WebDriver driver, String pageName) {
		...
		typeOfCoverrequiredTextField=new PageElement(By.xpath("//td//div[contains(text(),'Type of cover required')]/following::input"), " Type of cover required", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		// digvijay aa
		policyDescriptionTextArea=new PageElement(By.xpath("//td//div[contains(text(),'Policy Description')]/following::textarea"), " Policy Description", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		// digvijay ag
		typeofPolicyTextField=new PageElement(By.xpath("//td//div[contains(text(),'Type of Policy')]/following::input"), " Type of Policy", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		//digvijay ai
	...
	public void fillPolicyAttributeAviation(PolicyAttrAviationEntity policyAttrAviationEntity, CustomAssert assertReference) throws InterruptedException{
		if(policyAttrAviationEntity.getAction().equalsIgnoreCase("add") || policyAttrAviationEntity.getAction().equalsIgnoreCase("edit")){
			...
			if (policyAttrAviationEntity.getBooleanValueForField("ConfigTypeOfCoverrequired")) {
				clearAndSendKeys(typeOfCoverrequiredTextField, policyAttrAviationEntity.getStringValueForField("TypeOfCoverrequired"));
			}
			...
			if (policyAttrAviationEntity.getBooleanValueForField("ConfigTypeofPolicy")) {
				assertReference.assertEquals(policyAttrAviationEntity.getStringValueForField("TypeofPolicy"), fetchValueFromTextFields(typeofPolicyTextField), AssertionType.WARNING);
			}	
			if (policyAttrAviationEntity.getBooleanValueForField("ConfigTypeofLiability")) {
	...
	public void fillandSubmitPolicyAttributeAviation(PolicyAttrAviationEntity policyAttrAviationEntity, CustomAssert assertReference) throws InterruptedException {
		if(isConfigTrue(policyAttrAviationEntity.getConfigExecute())){
			...
			if(policyAttrAviationEntity.getStringValueForField("Product").equalsIgnoreCase("PN") || (policyAttrAviationEntity.getStringValueForField("Product").equalsIgnoreCase("AG")) || policyAttrAviationEntity.getStringValueForField("Product").equalsIgnoreCase("PA")){
