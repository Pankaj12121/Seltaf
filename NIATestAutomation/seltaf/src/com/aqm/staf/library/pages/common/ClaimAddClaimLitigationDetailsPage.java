...
public class ClaimAddClaimLitigationDetailsPage extends BasePage {
	...
	public void clickOnLocationOfTheCourtFindButton(ClaimLitigationEntity claimLitigationEntity) throws InterruptedException{
		if (claimLitigationEntity.getBooleanValueForField("ConfigLocationOfCourtFindButton")){
			if(claimLitigationEntity.getStringValueForField("LOB").equalsIgnoreCase("Engineering") || claimLitigationEntity.getStringValueForField("Product").equalsIgnoreCase("MP")||claimLitigationEntity.getStringValueForField("Product").equalsIgnoreCase("FM")||claimLitigationEntity.getStringValueForField("Product").equalsIgnoreCase("MC"))
			{
