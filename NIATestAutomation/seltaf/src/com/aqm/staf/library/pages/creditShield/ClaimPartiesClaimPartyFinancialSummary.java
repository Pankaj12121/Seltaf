...
public class ClaimPartiesClaimPartyFinancialSummary extends BasePage {
	...
	public void fillClaimPartiesClaimPartyFinancialSummary(ClaimPartiesFinanSumayEntity claimPartiesFinanSumayEntity, CustomAssert assertReference) throws InterruptedException{
		...
		if(claimPartiesFinanSumayEntity.getAction().equalsIgnoreCase("add") || claimPartiesFinanSumayEntity.getAction().equalsIgnoreCase("edit")){
			...
			if (claimPartiesFinanSumayEntity.getBooleanValueForField("ConfigSurveyComments")) {
				if(claimPartiesFinanSumayEntity.getStringValueForField("Product").equalsIgnoreCase("PP") && claimPartiesFinanSumayEntity.getStringValueForField("LOB").equalsIgnoreCase("Misc Liability") ){
			...
			if (claimPartiesFinanSumayEntity.getBooleanValueForField("ConfigPartyName")) {
				assertReference.assertEquals(claimPartiesFinanSumayEntity.getStringValueForField("PartyName"),fetchValueFromFields(partyNameLabel), AssertionType.WARNING);
			}
			...
			if (claimPartiesFinanSumayEntity.getBooleanValueForField("ConfigExpectedSurveyReportSubmissionDate")) {
				assertReference.assertEquals(RandomCodeGenerator.dateGenerator(claimPartiesFinanSumayEntity.getStringValueForField("ExpectedSurveyReportSubmissionDate")) ,fetchValueFromTextFields(expectedSurveyReportSubmissionDateTextField), AssertionType.WARNING);
			}
			if (claimPartiesFinanSumayEntity.getBooleanValueForField("ConfigSurveyComments")) {
	...
	public void saveFromClaimPartyFinancialSummary(ClaimPartiesFinanSumayEntity claimPartiesFinanSumayEntity) {
	...
	public void fillandSubmitClaimPartiesClaimPartyFinancialSummary(ClaimPartiesFinanSumayEntity claimPartiesFinanSumayEntity, CustomAssert assertReference) throws InterruptedException {
