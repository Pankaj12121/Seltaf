...
public class PolicyPremiumSchedulePage extends BasePage {
	...
	public PolicyPremiumSchedulePage(WebDriver driver, String pageName) {
		...
		//	totalPremiumIncludingTerrorismCoverTextField  = new PageElement(By.xpath(locatorforPanel("Total Premium ( Including Terrorism Cover )", "input")),"Total Premium ( Including Terrorism Cover ) Text Field", false, WaitType.WAITFORELEMENTTOBEDISPLAYED,10);	
