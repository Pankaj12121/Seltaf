...
public class PolGHT2PLRMemberPage extends BasePage {
	...
	public void nextButtonPolGHT2PLRMemberPage(PolGHT2PLRMemberEntity polGHT2PLRMemberEntity){
		if (polGHT2PLRMemberEntity.getBooleanValueForField("ConfigForwardButton")){		
			click(forwardButton);
			switchToFrame("display");
			nextPageTitle= new PageElement(By.xpath("//div//b//font[contains(text(),'"+polGHT2PLRMemberEntity.getStringValueForField("PolGHT1PLRMemberTitle")+"')]"), "BP MC Rate Chart 23 Title", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
