...
public class PolicyAttributePolicyDetails2PUPersonalAccident extends BasePage {
	...
	public PolicyAttributePolicyDetails2PUPersonalAccident(WebDriver driver, String pageName) {
		...
		typeOfCoverRequiredForPUDropDown= new PageElement(By.xpath("//td//div[contains(text(),'Type of cover required for PU')]/following::select"), "Type of cover required for PU Field ", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
