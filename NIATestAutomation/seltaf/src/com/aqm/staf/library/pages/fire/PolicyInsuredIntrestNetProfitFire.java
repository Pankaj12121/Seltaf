...
//LP DIGVIJAY
			...
			//Mayur_Product name=FD
			if (polInsInttNetProFireEntity.getBooleanValueForField("ConfigSumInsuredOfStocks")) {
				assertReference.assertEquals(polInsInttNetProFireEntity.getStringValueForField("SumInsuredOfStocks"), fetchValueFromTextFields(sumInsuredOfStocksTextField), AssertionType.WARNING);
			}
