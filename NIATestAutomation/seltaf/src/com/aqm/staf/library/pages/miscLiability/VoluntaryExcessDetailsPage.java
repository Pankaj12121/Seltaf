...
public class VoluntaryExcessDetailsPage extends BasePage{
	...
	public VoluntaryExcessDetailsPage(WebDriver driver, String pageName) {
		...
		deductibleTextField 		= new PageElement(By.xpath(locatorforQuestionAnswerPanel("Deductible","input")), "Deductible TextArea",false,WaitType.WAITFORELEMENTTOBEEENABLED,10);
