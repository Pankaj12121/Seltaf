...
public class PolicyMemberAttributeHealth extends BasePage {
	...
	public PolicyMemberAttributeHealth(WebDriver driver,String pageName,int rowcount) {
		...
		//********************************************** CX *******************************************************
		assigneeNameTextFeild=new PageElement(By.xpath(locatorforQuestionAnswerPanel("Assignee name","textarea")),"Assignee name Text Feild",false,WaitType.WAITFORELEMENTTOBEDISPLAYED,10);
		...
		nameOfAssigneeTextArea=new PageElement(By.xpath(locatorforQuestionAnswerPanel("Name of Assignee","textarea")),"Name of Assignee Text Area",false,WaitType.WAITFORELEMENTTOBEDISPLAYED,10);
		...
		relationshipWithTheAssigneeDropDown=new PageElement(By.xpath(locatorforQuestionAnswerPanel("Relationship with the Assignee","select")),"Relationship with the Assignee DropDown",false,WaitType.WAITFORELEMENTTOBEEENABLED,10);
		...
		assigneeAddressTextArea=new PageElement(By.xpath(locatorforQuestionAnswerPanel("Assignee Address","textarea")),"Assignee Address TextArea",false,WaitType.WAITFORELEMENTTOBEDISPLAYED,10);
		assigneeContactNumberTextField=new PageElement(By.xpath(locatorforQuestionAnswerPanel("Assignee Contact Number","input")),"Assignee Contact Number TextField",false,WaitType.WAITFORELEMENTTOBEDISPLAYED,10);
		...
		hOApprovalNoTextBox= new PageElement(By.xpath(locatorforQuestionAnswerPanel("HO Approval No.","input")),"HO Approval No TextField",false,WaitType.WAITFORELEMENTTOBEDISPLAYED,10);
	...
	public void submitPolicyMemberAttribute(PolicyMemberAttributeEntity policyMemberAttributeEntity) {
		...
		//ES Abhijit
			...
			if(policyMemberAttributeEntity.getStringValueForField("Product").equalsIgnoreCase("JA")||(policyMemberAttributeEntity.getStringValueForField("Product").equalsIgnoreCase("GJ"))){
				click(nextButton);
			}
			click(nextButton);
			click(saveButton);
