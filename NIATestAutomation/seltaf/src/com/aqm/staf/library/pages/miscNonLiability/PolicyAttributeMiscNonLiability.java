...
public class PolicyAttributeMiscNonLiability extends BasePage {
	...
	public PolicyAttributeMiscNonLiability(WebDriver driver, String pageName,int rowCounts) {
		...
		policyTypeOfficeProtectionShieldDropDown=new PageElement(By.xpath("//td/div[contains(text(),'Policy Type Office Protection Shield')]/following::select"),"Policy Type Office Protection Shield DropDown", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		typeOfOccupantDropDown=new PageElement(By.xpath("//td/div[contains(text(),'Type of Occupant')]/following::select"),"Type Of Occupant DropDown", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
	...
	private void fillBusinessDirectDetailsForBI(PolAttributeMNLEntity polAttributeMNLEntity,CustomAssert assertReference) {
		if(polAttributeMNLEntity.getAction().equalsIgnoreCase("add") || polAttributeMNLEntity.getAction().equalsIgnoreCase("edit")){
			...
			//BI-Rajkumar- verify
			if(polAttributeMNLEntity.getBooleanValueForField("ConfigSpecialEconomicZone")){
				assertReference.assertEquals(polAttributeMNLEntity.getStringValueForField("SpecialEconomicZone"), fetchValueFromFields(specialEconomicZoneDropDown), AssertionType.WARNING);
			}
			if(polAttributeMNLEntity.getBooleanValueForField("ConfigCoInsuranceApplicable")){
				assertReference.assertEquals(polAttributeMNLEntity.getStringValueForField("CoInsuranceApplicable"), fetchValueFromFields(coInsuranceApplicableDropDown), AssertionType.WARNING);
			}	
			if(polAttributeMNLEntity.getBooleanValueForField("ConfigDiscountforDirectBusinessPB")){
				assertReference.assertEquals(polAttributeMNLEntity.getStringValueForField("DiscountforDirectBusiness"), fetchValueFromTextFields(discountforDirectBusinessTextField), AssertionType.WARNING);
			}
	...
	private void fillTypeOfDevelopmentHidden(PolAttributeMNLEntity polAttributeMNLEntity,CustomAssert assertReference) {
		if(polAttributeMNLEntity.getAction().equalsIgnoreCase("add") || polAttributeMNLEntity.getAction().equalsIgnoreCase("edit")|| polAttributeMNLEntity.getAction().equalsIgnoreCase("verify")){
			click(forwordButton);
		}
	}
	...
	public void fillandSubmitPolicyAttributeMNLDetails(PolAttributeMNLEntity polAttributeMNLEntity,CustomAssert assertReference) throws InterruptedException{
		if(isConfigTrue(polAttributeMNLEntity.getConfigExecute())){
			...
			if(!(polAttributeMNLEntity.getStringValueForField("Product").equalsIgnoreCase("FI")||polAttributeMNLEntity.getStringValueForField("Product").equalsIgnoreCase("SE"))){
				fillPolicyAttributeMNLDetails(polAttributeMNLEntity,assertReference);
				clickOnForwardButton(polAttributeMNLEntity);
			}
			if(polAttributeMNLEntity.getStringValueForField("Product").equalsIgnoreCase("SK")){
				fillPolicyDetailsTwo(polAttributeMNLEntity, assertReference);
			}
			if(polAttributeMNLEntity.getStringValueForField("Product").equalsIgnoreCase("BI")||polAttributeMNLEntity.getStringValueForField("Product").equalsIgnoreCase("PB")||polAttributeMNLEntity.getStringValueForField("Product").equalsIgnoreCase("FI")||polAttributeMNLEntity.getStringValueForField("Product").equalsIgnoreCase("FS")||polAttributeMNLEntity.getStringValueForField("Product").equalsIgnoreCase("SE")||polAttributeMNLEntity.getStringValueForField("Product").equalsIgnoreCase("SH")||polAttributeMNLEntity.getStringValueForField("Product").equalsIgnoreCase("SK")||polAttributeMNLEntity.getStringValueForField("Product").equalsIgnoreCase("HH")){
				fillBusinessDirectDetailsForBI(polAttributeMNLEntity, assertReference);
			}
			if(polAttributeMNLEntity.getStringValueForField("Product").equalsIgnoreCase("OS")||polAttributeMNLEntity.getStringValueForField("Product").equalsIgnoreCase("HH")||polAttributeMNLEntity.getStringValueForField("Product").equalsIgnoreCase("SH")){
