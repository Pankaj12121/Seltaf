...
public class StandardCoverDetailsForMiscNL extends BasePage {
	...
	public void fillStandardCoverDetailsForMiscNL(StandCovDetForMiscNLEntity standCovDetForMiscNLEntity, CustomAssert assertReference) throws InterruptedException{
		if(standCovDetForMiscNLEntity.getAction().equalsIgnoreCase("add") || standCovDetForMiscNLEntity.getAction().equalsIgnoreCase("edit")){
			...
			if (standCovDetForMiscNLEntity.getBooleanValueForField("ConfigDescriptionforSectionI")) {
				assertReference.assertEquals(standCovDetForMiscNLEntity.getStringValueForField("DescriptionforSectionI"), fetchValueFromList(descriptionforSectionITextArea), AssertionType.WARNING);
			}
			if (standCovDetForMiscNLEntity.getBooleanValueForField("ConfigSumInsuredforSectionI")) {
				assertReference.assertEquals(standCovDetForMiscNLEntity.getStringValueForField("SumInsuredforSectionI"), fetchValueFromList(sumInsuredforSectionITextField), AssertionType.WARNING);
			}
			if (standCovDetForMiscNLEntity.getBooleanValueForField("ConfigPremiumforSectionI")) {
				assertReference.assertEquals(standCovDetForMiscNLEntity.getStringValueForField("PremiumforSectionI"), fetchValueFromList(premiumforSectionITextField), AssertionType.WARNING);
			}
			...
			if (standCovDetForMiscNLEntity.getBooleanValueForField("ConfigPaymentoftuitionandhostelfee")) {
				assertReference.assertEquals(standCovDetForMiscNLEntity.getStringValueForField("Paymentoftuitionandhostelfee"), fetchValueFromList(paymentoftuitionandhostelfeeTextField), AssertionType.WARNING);
			}
			if (standCovDetForMiscNLEntity.getBooleanValueForField("ConfigNumberofParents")) {
				assertReference.assertEquals(standCovDetForMiscNLEntity.getStringValueForField("NumberofParents"), fetchValueFromList(numberofParentsTextField), AssertionType.WARNING);
			}
			//JI
			if (standCovDetForMiscNLEntity.getBooleanValueForField("ConfigGoodFeatureDiscount")) {
			...
			if (standCovDetForMiscNLEntity.getBooleanValueForField("ConfigAdditionalPremiumSKForNoOfBranches")) {
				assertReference.assertEquals(standCovDetForMiscNLEntity.getStringValueForField("AdditionalPremiumSKForNoOfBranches"), fetchValueFromList(additionalPremiumSKForNoOfBranchesTextField), AssertionType.WARNING);
			}
		}
	}		
