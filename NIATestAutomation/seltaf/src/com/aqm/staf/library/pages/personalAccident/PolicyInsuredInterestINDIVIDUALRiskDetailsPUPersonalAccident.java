...
public class PolicyInsuredInterestINDIVIDUALRiskDetailsPUPersonalAccident  extends BasePage  {
	...
	public PolicyInsuredInterestINDIVIDUALRiskDetailsPUPersonalAccident(WebDriver driver, String pageName,int rowcount) {
		...
		insuredInterestSerialNoLabel=new PageElement(By.xpath(genericLocatorforLabel("S0042", "Serial No")), "Insured Interest Serial No Label", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		...
		nameoftheMemberTextField=new PageElement(By.xpath("//td//div[contains(text(),'Name of the Member')]/following::input"), "Name of the Member Text Field", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		...
		relationshipwiththePolicyholderofPUDropDown	=new PageElement(By.xpath("//td//div[contains(text(),'Relationship with the Policy holder of PU')]/following::select"), "Relationship with the Policy holder of PU DropDown", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		relationshipwiththeEmployeeDropDown=new PageElement(By.xpath("//td//div[contains(text(),'Relationship with the Employee')]/following::select"), "Relationship with the Employee DropDown", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		...
		nomineeNameTextField = new PageElement(By.xpath("//td//div[contains(text(),'Nominee Name')]/following::input"), "Nominee Name TextField", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		...
		serialNoTextField = new PageElement(By.xpath("//td//div[contains(text(),'Serial No')]/following::input"), "Serial No TextField", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		...
		occupationoftheMemberofPUIndividualDropDown=new PageElement(By.xpath("//td//div[contains(text(),'Occupation of the Member of PU Individual')]/following::select"), "Medical extension Required DropDown", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
	...
	cadreDetailsWindowNoofpersonpercadreTextField =new PageElement(By.name("Data_226903002072010_"+rowcount+""), "No of person per cadre Text Field", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		...
		premiumForMemberWindowAdditionDeletionDropDown=new PageElement(By.name("Data_301791520082013_"+rowcount+""), "Premium Window Addition Deletion DropDown", false, WaitType.WAITFORELEMENTTOBECLICKABLE, 10);
		premiumForMemberWindowNoofpersonsTextField=new PageElement(By.name("Data_301795323082013_"+rowcount+""), "Premium Window No of persons  Text Field", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		premiumForMemberWindowDescriptionofCategoryTextField=new PageElement(By.name("Data_301791820082013_"+rowcount+""), "Premium Window Description of Category Text Field", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
	...
	public void fillPolicyInsuredInterestINDIVIDUALRiskDetailsPUPersonalAccident(PolInsIntINDRiskDetPUEntity polInsIntINDRiskDetPUEntity, CustomAssert assertReference) throws InterruptedException {
		...
		//individual
			...
			if (polInsIntINDRiskDetPUEntity.getBooleanValueForField("ConfigRelationshipWiththeEmployee")) {
				selectValueFromList(relationshipwiththeEmployeeDropDown, polInsIntINDRiskDetPUEntity.getStringValueForField("RelationshipWiththeEmployee"));
			}
	...
	public void fillPremiumForMemberDetails(PolInsIntINDRiskDetPUEntity polInsIntINDRiskDetPUEntity) throws InterruptedException{
		...
		if(polInsIntINDRiskDetPUEntity.getBooleanValueForField("ConfigPremiumForMemberWindowAdditionDeletion")){
			selectValueFromList(premiumForMemberWindowAdditionDeletionDropDown,polInsIntINDRiskDetPUEntity.getStringValueForField("PremiumForMemberWindowAdditionDeletion") );
		}
