...
public class ClaimRiskPropertyT3CLRAviation extends BasePage {
	...
	public void proceedToT2CLRForHealthProducts(ClaimRiskProT3CLRAviEntity claimRiskProT3CLRAviEntity){
		if (claimRiskProT3CLRAviEntity.getBooleanValueForField("ConfigProceedButton")){		
			...
			nextPageTitle= new PageElement(By.xpath("//div//b[contains(text(),'"+claimRiskProT3CLRAviEntity.getStringValueForField("ClaimMemberT3Title")+"')]"), "Next Page Title", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
	...
	public void fillandSubmitClaimMemberT1CLRAttibutesHealth(ClaimRiskProT3CLRAviEntity claimRiskProT3CLRAviEntity, CustomAssert assertReference) throws InterruptedException {
