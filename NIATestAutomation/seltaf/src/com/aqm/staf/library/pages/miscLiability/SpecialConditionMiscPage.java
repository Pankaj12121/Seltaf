...
public class SpecialConditionMiscPage extends BasePage {
	...
	public SpecialConditionMiscPage(WebDriver driver, String pageName) {
		...
		isThisIndianInterestAbroadPolicyDropdown=new PageElement(By.xpath("//tr//td//div[contains(text(),'Is this Indian Interest Abroad policy?')]/following::select"), "Is this Indian Interest Abroad policy Drop Down",false,WaitType.WAITFORELEMENTTOBEEENABLED,10);
