...
public class PolicyInsuredIntrestAttributeMiscNL extends BasePage{
	...
	public PolicyInsuredIntrestAttributeMiscNL(WebDriver driver, String pageName,int rowcount) {
		...
		pinCodeDropDown=new PageElement(By.xpath(locatorforQuestionAnswerPanel("Pin Code","select")), "Pin Code", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		...
		specialConditionTextArea=new PageElement(By.xpath(locatorforQuestionAnswerPanel("Special Condition", "textarea")), "Special Condition", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		...
		contentsExcludingMoneyAndValuablesArticlesOfConsumableNature1FurnitureAndFixtureFittingTextField=new PageElement(By.name("Data_258327904032011_0"), "Contents excluding money and valuables articles of consumable nature (1) Furniture and Fixture, Fitting TextField", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
	...
	public void fillRiskDetailsOfT1PLRForMiscNL(PolInsIntAttrMNLEntity policyInsIntAttrMNLEntity, CustomAssert assertReference) throws InterruptedException{
		if(policyInsIntAttrMNLEntity.getAction().equalsIgnoreCase("add") || policyInsIntAttrMNLEntity.getAction().equalsIgnoreCase("edit")){
			...
			if (policyInsIntAttrMNLEntity.getBooleanValueForField("ConfigPinCode")) {
				selectValueFromList(pinCodeDropDown, policyInsIntAttrMNLEntity.getStringValueForField("PinCode"));
			}
			...
			if (policyInsIntAttrMNLEntity.getBooleanValueForField("ConfigPinCode")) {
				assertReference.assertEquals(policyInsIntAttrMNLEntity.getStringValueForField("PinCode"), fetchValueFromList(pinCodeDropDown), AssertionType.WARNING);
			}
			if (policyInsIntAttrMNLEntity.getBooleanValueForField("ConfigSpecialPerils")) {
			...
			//PB - Priyanka
			if (policyInsIntAttrMNLEntity.getBooleanValueForField("ConfigNameOfTheMember")) {
				assertReference.assertEquals(policyInsIntAttrMNLEntity.getStringValueForField("NameOfTheMember"), fetchValueFromTextFields(nameOfTheMemberTextField), AssertionType.WARNING);
			}
			if (policyInsIntAttrMNLEntity.getBooleanValueForField("ConfigDateOfBirth")) {
				assertReference.assertEquals(policyInsIntAttrMNLEntity.getStringValueForField("DateOfBirth"), fetchValueFromTextFields(dateOfBirthTextField), AssertionType.WARNING);
			}
			if (policyInsIntAttrMNLEntity.getBooleanValueForField("ConfigSex")) {
			...
			if (policyInsIntAttrMNLEntity.getBooleanValueForField("ConfigDateOfIssue")) {
				assertReference.assertEquals(policyInsIntAttrMNLEntity.getStringValueForField("DateOfIssue"), fetchValueFromTextFields(dateOfIssueTextField), AssertionType.WARNING);
			}
			if (policyInsIntAttrMNLEntity.getBooleanValueForField("ConfigVisaType")) {
				assertReference.assertEquals(policyInsIntAttrMNLEntity.getStringValueForField("VisaType"), fetchValueFromTextFields(visaTypeTextField), AssertionType.WARNING);
			}
			if (policyInsIntAttrMNLEntity.getBooleanValueForField("ConfigCorrespondingAddressIndia")) {
			...
			if (policyInsIntAttrMNLEntity.getBooleanValueForField("ConfigRelationshipOfNextKin")) {
				assertReference.assertEquals(policyInsIntAttrMNLEntity.getStringValueForField("RelationshipOfNextKin"), fetchValueFromTextFields(relationshipOfNextKinTextField), AssertionType.WARNING);
			}
			if (policyInsIntAttrMNLEntity.getBooleanValueForField("ConfigAddressOfNextKin")) {
	...
	public void fillandsubmitRiskDetailsOfT1PLRForMiscNL(PolInsIntAttrMNLEntity policyInsIntAttrMNLEntity, CustomAssert assertReference) throws InterruptedException {
		if(isConfigTrue(policyInsIntAttrMNLEntity.getConfigExecute())){
			...
			if(policyInsIntAttrMNLEntity.getStringValueForField("Product").equalsIgnoreCase("FI")){
