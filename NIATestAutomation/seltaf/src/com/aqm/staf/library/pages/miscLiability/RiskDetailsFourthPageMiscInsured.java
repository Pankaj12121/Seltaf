...
public class RiskDetailsFourthPageMiscInsured  extends BasePage{
	...
	public RiskDetailsFourthPageMiscInsured(WebDriver driver, String pageName) {
		...
		deductibleTextField=new PageElement(By.xpath("//td//div[contains(text(),'Deductible')]/following::input"), "Deductible Text Field", false,WaitType.WAITFORELEMENTTOBEEENABLED,10);
