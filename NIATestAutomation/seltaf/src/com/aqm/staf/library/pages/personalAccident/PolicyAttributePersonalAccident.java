...
public class PolicyAttributePersonalAccident extends BasePage {
	...
	public PolicyAttributePersonalAccident(WebDriver driver, String pageName ){
		...
		//Product PH Good Health Personal Accident
		goodHealthMonthDropdown= new PageElement(By.xpath("//form[@name='S0042']//tr//td//div[contains(text(),'Good Health Month')]/following::td"), "Good Health Month Dropdown", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		schemeYearTextField= new PageElement(By.xpath("//form[@name='S0042']//tr//td//div[contains(text(),'Scheme Year')]/following::input"), "Scheme Year Text Field", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
