...
public class AviationRiskDetailT3PLR extends BasePage {
	...
	public AviationRiskDetailT3PLR(WebDriver driver, String pageName) {
		...
		deductibleTextField= new PageElement(By.xpath("//td//div[contains(text(),'Deductible')]/following::input"), "Nature of Extension Text Field", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
