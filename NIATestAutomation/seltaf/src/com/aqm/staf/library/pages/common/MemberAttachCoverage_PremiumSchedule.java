...
public class MemberAttachCoverage_PremiumSchedule extends BasePage {
	...
	public MemberAttachCoverage_PremiumSchedule(WebDriver driver,String pageName) {
		...
		manualLoadingTextField=new PageElement(By.xpath("//form[@name='S0050']//td//b[contains(text(),'Manual Loading')]/following::td/input"),"ManualLoading",false,WaitType.WAITFORELEMENTTOBEDISPLAYED,10);
		...
		//DC
		discountTextField=new PageElement(By.xpath("//form[@name='S0050']//td//b[contains(text(),'Discount')]/following::td[1]/input"),"Discount for DC",false,WaitType.WAITFORELEMENTTOBEDISPLAYED,10);
		...
		premiumForDCTextField=new PageElement(By.xpath("//form[@name='S0050']//td//b[contains(text(),'Premium')]/following::td[11]/input"),"Premium for DC",false,WaitType.WAITFORELEMENTTOBEDISPLAYED,10);
		...
		premiumTextField =new PageElement(By.xpath("//form[@name='S0050']//tr[3]//td//b[contains(text(),'Premium')]/following::td/input"),"Premium",false,WaitType.WAITFORELEMENTTOBEDISPLAYED,10);
	...
	public void fillPolicyMemberPremiumDetails(MembAtachCovrgPremSchdEntity membAtachCovrgPremSchdEntity, CustomAssert assertReference){
		if(membAtachCovrgPremSchdEntity.getBooleanValueForField("ConfigPrimaryInformation")){
			if(membAtachCovrgPremSchdEntity.getAction().equalsIgnoreCase("add") || membAtachCovrgPremSchdEntity.getAction().equalsIgnoreCase("edit")){
				...
				if (membAtachCovrgPremSchdEntity.getBooleanValueForField("ConfigPremium")) {
					if(membAtachCovrgPremSchdEntity.getStringValueForField("Product").equalsIgnoreCase("ZP"))
					{
		...
		public void submitPolicyPremiumDetails(MembAtachCovrgPremSchdEntity MembAtachCovrgPremSchdEntity) {
		...
		public void fillandcalculatePremiumPolicyDetails1(MembAtachCovrgPremSchdEntity MembAtachCovrgPremSchdEntity, CustomAssert assertReference) throws InterruptedException {
			switchToFrame("display");
		...
		public void fillandSubmitPolicyPremiumDetails(MembAtachCovrgPremSchdEntity 	membAtachCovrgPremSchdEntity, CustomAssert assertReference)throws InterruptedException {
			if(isConfigTrue(membAtachCovrgPremSchdEntity.getConfigExecute())){
				...
				fillPolicyMemberPremiumDetails(membAtachCovrgPremSchdEntity, assertReference);
				calculatePremiumPolicyButton(membAtachCovrgPremSchdEntity);
				submitPolicyPremiumDetails(membAtachCovrgPremSchdEntity);
