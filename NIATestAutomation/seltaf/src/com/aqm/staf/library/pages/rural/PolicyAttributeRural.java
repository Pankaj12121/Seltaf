...
public class PolicyAttributeRural extends BasePage {
	...
	public PolicyAttributeRural(WebDriver driver, String pageName) {
		...
		typeOfPolicyRuralDropDown=new PageElement(By.xpath("//form[@name='S0042']//tr//td//div[contains(text(),'Type of Policy(Rural)')]/following::select"), "Type of Policy Rural DropDown", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		...
		//FW
		clientTypeRuralDropDown=new PageElement(By.xpath("//form[@name='S0042']//tr//td//div[contains(text(),'Client Type(Rural)')]/following::select"), "Client Type(Rural) DropDown", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		//PG-Shruti
	...
	public void fillPolicyAttributeRural(PolicyAttributeRuralEntity policyAttributeRuralEntity, CustomAssert assertReference){
		if(policyAttributeRuralEntity.getAction().equalsIgnoreCase("add") || policyAttributeRuralEntity.getAction().equalsIgnoreCase("edit")){
			...
			if (policyAttributeRuralEntity.getBooleanValueForField("ConfigClientTypeRural")) {
				selectValueFromList(clientTypeRuralDropDown, policyAttributeRuralEntity.getStringValueForField("ClientTypeRural"));
			}
			//PG-shruti
