...
public class ClaimAttributes extends BasePage {
	...
	public ClaimAttributes(WebDriver driver, String pageName) {
		...
		claimNumberLabel = new PageElement(By.xpath(genericLocatorforLabel("S0190", "Claim")),"Claim Number Label", false, WaitType.WAITFORELEMENTTOBEDISPLAYED,10);
		...
		productCodeLabel = new PageElement(By.xpath(genericLocatorforLabel("S0190", "Product")),"Product Code Label", false, WaitType.WAITFORELEMENTTOBEDISPLAYED,10);
